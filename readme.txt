...
USING HYBRIDMT/FOCIMT UNDER LINUX/OSX systems

To use the package under Linux/OSX systems you firstly have to compile the 
focimt binary following the guidelines located in ./src/howto_compile_focimt.txt
file. The compiled binary file focimt. should be moved to the location where 
focimt.m (or focimt.exe) scripts reside.
